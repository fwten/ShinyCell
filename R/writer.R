...
wrSVfix <- function() {
  glue::glue('### Useful stuff \n',
             ...
             '                     inpH5, inpGene, \n',
             '                     inpsiz, inpcol, inpord, inpfsz, inpasp, inptxt,inpsplit=FALSE,splitBy, inpcolorscale,inpcustomscale=FALSE){{ \n',
             '  if(is.null(inpsub1)){{inpsub1 = inpConf$UI[1]}} \n',
             '  # Prepare ggData \n',
             '  if(!inpsplit) {{  \n',
             '    ggData = inpMeta[, c(inpConf[UI == inpdrX]$ID, inpConf[UI == inpdrY]$ID, \n',
             ...
             '    sctheme(base_size = sList[inpfsz], XYval = inptxt)  \n',
             '  if(inpcustomscale){{ \n',
             '    ggOut = ggOut + scale_color_gradientn(inp1, colours = cList[[inpcol]], limits = c(0, inpcolorscale)) \n',
             '  }} else {{\n',
             '    ggOut = ggOut + scale_color_gradientn(inp1, colours = cList[[inpcol]]) \n',
             '  }} \n',
             '    ggOut = ggOut + guides(color = guide_colorbar(barwidth = 15)) \n',
             '  if(inpasp == "Square") {{ \n',
             '    ggOut = ggOut + coord_fixed(ratio = rat) \n',
             '  }} else if(inpasp == "Fixed") {{ \n',
             '    ggOut = ggOut + coord_fixed() \n',
...
wrSVmain <- function(prefix, subst = "") {
  glue::glue('optCrt="{{ option_create: function(data,escape) {{return(\'<div class=\\"create\\"><strong>\' + \'</strong></div>\');}} }}" \n',
             ...
             '             input${prefix}a1fsz, input${prefix}a1asp, input${prefix}a1txt,input${prefix}a1sub1cond, input${prefix}a1sub1condGrp, input${prefix}a1colorscale, input${prefix}a1customscale) \n',
             '  }}) \n',
             ...
             '             input${prefix}a3fsz, input${prefix}a3asp, input${prefix}a3txt,input${prefix}a3sub1cond, input${prefix}a3sub1condGrp, input${prefix}a3colorscale, input${prefix}a3customscale) \n',
             '  }}) \n',
...
wrUImain <- function(prefix, subst = "", ptsiz = "1.25") {
  glue::glue('  ### Tab1.a1: cellInfo vs geneExpr on dimRed \n',
             ...
             '              sliderInput("{prefix}a1colorscale", "Color scale:", \n',
             '                             min = 0, max = 20, value = 10, step = 0.25), \n',
             '              checkboxInput("{prefix}a1customscale", "Custom color scale limit", value = FALSE) %>%  \n',
             '                helper(type = "inline", size = "m", fade = TRUE, \n',
             '                       title = "Custom color scale limit", \n', 
             '                       content = c("Set the maximum for the gene expression coloring in the UMAPs", \n', 
             '                                  paste0("- If the expression is higher than the set limit, ", \n', 
             '                                         "it will be displayed as a dark gray color instead", \n', 
             '                                         "\ne.g.: limit is 5 (dark red), anything > 5 will be dark gray"))), \n',
             '            ) \n',
             '          ) \n',
             '        ) \n',
             '      )  # End of column (6 space) \n',
             ...
             '    fluidRow( \n',
             '      column( \n',
             '        6{subst}, actionButton("{prefix}a1togCond", "Toggle splitting by condition"), \n',
             '{subst}        conditionalPanel( \n',
             ...
             '    fluidRow( \n',
             '      column( \n',
             '        6{subst}, actionButton("{prefix}a2togCond", "Toggle splitting by condition"), \n',
             '{subst}        conditionalPanel( \n',
             ...
             '              sliderInput("{prefix}a3colorscale", "Color scale:", \n',
             '                             min = 0, max = 20, value = 10, step = 0.25), \n',
             '              checkboxInput("{prefix}a3customscale", "Custom color scale limit", value = FALSE) %>%  \n',
             '                helper(type = "inline", size = "m", fade = TRUE, \n',
             '                       title = "Custom color scale limit", \n', 
             '                       content = c("Set the maximum for the gene expression coloring in the UMAPs", \n', 
             '                                  paste0("- If the expression is higher than the set limit, ", \n', 
             ...
             '    fluidRow( \n',
             '      column( \n',
             '        6{subst}, actionButton("{prefix}a3togCond", "Toggle splitting by condition"), \n',
             '{subst}        conditionalPanel( \n',
             ...
             '    fluidRow( \n',
             '      column( \n',
             '        6{subst}, actionButton("{prefix}b2togCond", "Toggle splitting by condition"), \n',
             '{subst}        conditionalPanel( \n',
             ...
             '    fluidRow( \n',
             '      column( \n',
             '        12{subst}, actionButton("{prefix}c1togCond", "Toggle splitting by condition"), \n',
             '{subst}        conditionalPanel( \n',
             ...
             '    fluidRow( \n',
             '      column( \n',
             '        6{subst}, actionButton("{prefix}c2togCond", "Toggle splitting by condition"), \n',
             '{subst}        conditionalPanel( \n',
